...
8 golden items · prompt `answer_v0` · top_n=6 · budget=3000 tokens
...
| config            |   usable_rate |   grounded_rate |   has_citations_rate |   fabrication_rate |   n_fabricated_total | correct_refusals   |   wrong_refusals |   mean_sources_cited |   answer_words_median |   over_length_rate |   leaked_reasoning_rate |   latency_p50_ms |   latency_p95_ms |   n_timed |   errors |
|:------------------|--------------:|----------------:|---------------------:|-------------------:|---------------------:|:-------------------|-----------------:|---------------------:|----------------------:|-------------------:|------------------------:|-----------------:|-----------------:|----------:|---------:|
| llama3.2:3b       |         1     |           1     |                1     |                  0 |                    0 | 0/0                |                0 |                 1.5  |                    37 |                  0 |                       0 |            61202 |            88230 |         8 |        0 |
| gpt-oss:20b-cloud |         0.875 |           0.875 |                0.875 |                  0 |                    0 | 0/0                |                1 |                 1.25 |                    19 |                  0 |                       0 |             6568 |            16372 |         8 |        0 |
| phi4-mini         |         0.875 |           0.875 |                0.875 |                  0 |                    0 | 0/0                |                1 |                 1.38 |                    26 |                  0 |                       0 |            73021 |            90609 |         8 |        0 |
